...
const Engels = () => {
    return(
        ...
        <div className="textAboutBranche">
            <p>Главной задачей Энгельсского филиала является создание условий для получения высоких и устойчивых урожаев сельскохозяйственных культур на орошаемых полях при условии эффективного использования воды и земельных ресурсов. Энгельсский филиал осуществляет эксплуатацию Энгельсской оросительной систем – одной из самых старейших оросительных систем Саратовского Заволжья. В ноябре 2015 года ЭОС отметила свой 50-летний юбилей.</p>
            <img src="/img/engels1.jpg"/>
            <img src="/img/engels2.jpg"/>
        </div>
