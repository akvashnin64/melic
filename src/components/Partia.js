...
const Partia = () => {
    return(
        ...
        <div className="textAboutBranche">
            <p>Основной задачей ГМП является комплексное изучение гидрогеологических и почвенно-мелиоративных условий орошаемых земель с целью надзора за их мелиоративным состоянием, назначением мероприятий по предотвращению неблагоприятного влияния орошения на мелиоративную обстановку орошаемых земель. На базе Гидрогеолого-мелиоративной партии имеется химико-бактериологическая лаборатория.</p>
            <img src="/img/partia1.jpg"/>
            <img src="/img/partia2.jpg"/>
        </div>
