        ...
        <div className="containerChannelsBranche">
            <div className="containerLeftChannelsBranche">
                <div className="leftChannelsBranche">
                    ...
                    <p>ВСЕГО МАГИСТРАЛЬНЫМИ КАНАЛАМИ ФИЛИАЛА В 2015 ГОДУ БЫЛО ПОДАНО 113 МЛН КУБИЧЕСКИХ МЕТРОВ ВОДЫ.</p>
                </div>
                <div className="leftChannelsBranche">
                    <img src="/img/plant.png"/>
                    <p>НА БАЛАНСЕ ФИЛИАЛА ЭКСПЛУАТИРУЕТСЯ СЕЛЬХОЗУЧАСТОК - 2281 ГЕКТАР ЗЕМЛИ, НА КОТОРОМ ВЫРАЩИВАЮТСЯ ОЗИМАЯ ПШЕНИЦА, ЯЧМЕНЬ, ПРОСО, ПОДСОЛНЕЧНИК.</p>
                </div>
            </div>
