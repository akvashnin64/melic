...
const Penza = () => {
    return(
        ...
        <div className="textAboutBranche">
            <p>Пензенский филиал ФГБУ «Управление «Саратовмелиоводхоз» <span className="boldText500">создан 20 августа 2021г.</span> на основании приказа Министерства сельского хозяйства Российской Федерации № 61 от 08 февраля 2021г. «О реорганизации федерального государственного бюджетного учреждения «Управление мелиорации земель и сельскохозяйственного водоснабжения по Саратовской области». Основной функцией Пензенского филиала в настоящее время является <span className="boldText500">обеспечение безаварийной работы мелиоративных систем и отдельно расположенных гидротехнических сооружений.</span></p>
            <img className="firstImageBranche" src="/img/penza1.jpg"/>
            <img className="secondImageBranche" src="/img/penza2.jpg"/>
        </div>
